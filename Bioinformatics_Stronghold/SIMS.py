...
strings = [str(string.seq) for string in SeqIO.parse("C:/Users/anqja/Downloads/rosalind_sims.txt","fasta")]
backtrack,alignment_score,w_sink = FittingAlign(strings[0],strings[1])
