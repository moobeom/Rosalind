...
def ImprovedBreakpointReversalSort(p,s):
    ...
    return reversal,flips

p = [int(num) for num in '4 10 2 6 9 7 3 5 1 8'.split()]
r = [int(num) for num in '3 4 1 10 9 8 5 6 7 2'.split()]
d, flips = ImprovedBreakpointReversalSort(p,r)
print(d)
for flip in flips:
